...
> 微信小程序或公众号相关接口方法：已从 `微信v2` 移步替换成 `github.com/ttsszzyy/wechat-sdk`
...
```bash
go get -u github.com/ttsszzyy/gopay
```
...
* #### [Wechat](https://github.com/ttsszzyy/gopay/blob/main/doc/wechat_v3.md)
